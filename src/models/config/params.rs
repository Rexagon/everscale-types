...
pub struct MsgsExecutionParams {
    ...
    /// The maximum number of incoming messages on account
    /// to be processed within the normal partition 0.
    /// When the messages queue on the account exceeds the limit
    /// it will be processed within the other paratitions.
    pub par_0_msgs_count_limit: u32,
